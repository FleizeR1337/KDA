...
vid = cv2.VideoCapture(0, cv2.CAP_DSHOW)  # Используйте CAP_DSHOW вместо API по умолчанию
vid.set(4, 1920)  # Ширина 1920 пикселей (увеличенное разрешение)
vid.set(3, 1080)   # Высота 1080 пикселей (увеличенное разрешение)
...
with mp_pose.Pose(
    ...
    while vid.isOpened():
        ...
        try:
            ...
            if workout_type == 'PushUp':
                cv2.putText(image, 'Push Up Counter: ' + str(push_up_counter), (image_width - 400, 50),
